...
module ChatgptAssistant
  ...
  class NewChatService
    ...
    def call
      ...
      chat = Chat.new(title: @chat_title, user_id: @user_id, status: 0, actor: actor_name, prompt: actor.prompt) if actor
      chat = Chat.new(title: @chat_title, user_id: @user_id, status: 0) unless actor
      if chat.save
